...
public class InvitationController {
    ...
    @PostMapping("/api/v1/oneops/invites")
    ...
    @GetMapping("/api/v1/oneops/auth/invites/preview")
    public InvitationPreview preview(@RequestParam String token) {
    ...
    @PostMapping("/api/v1/oneops/invites/revoke")
    @PreAuthorize(Authorize.ORG_MEMBER_INVITE)
    ...
    @PostMapping("/api/v1/oneops/invites/resend")
    @PreAuthorize(Authorize.ORG_MEMBER_INVITE)
    public Map<String, UUID> resend(@CurrentUser PrabhixPrincipal principal, @RequestParam UUID id) {
